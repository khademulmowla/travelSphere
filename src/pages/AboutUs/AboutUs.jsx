...
const AboutUs = () => {
    return (
        <div className="min-h-screen flex items-center justify-center px-4 bg-gray-100 dark:bg-gray-700 dark:text-white">
            ...
            <div className="max-w-3xl w-full bg-white shadow-lg rounded-2xl p-6 md:p-10 dark:bg-gray-400 ">
                <h3 className="text-3xl font-bold text-center dark:text-gray-500 text-gray-800 mb-6">Welcome!</h3>
